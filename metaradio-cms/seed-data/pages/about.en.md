...
| --- | --- | --- | --- |
| cyan | Team | EM first principles × GPU engineering | Professors from BJTU / BIT bring the first principles of electromagnetics and channels; practitioners from Samsung / DiDi / VIAVI bring GPU and systems engineering. Two kinds of DNA, one team. |
| emerald | Tech stack | A GPU-accelerated EM compute stack from simulation to terminal | Lauraycs (simulation) ↔ Liquid RF (terminal runtime) share one GPU-accelerated EM compute stack and AI-Native methodology — one EM reality, two infrastructures. |
| amber | Business model | R&D infrastructure + terminal connectivity platform | Like XtalPi — R&D infrastructure for AI-for-Wireless; like Qualcomm — the connectivity platform for next-gen terminals. A hybrid model from R&D services to platform licensing. |
...
- CAICT
- Shanghai Inst. of Physical Intelligence & Robotics

# Locations

- Beijing
- Shanghai
- Industry labs: Chongqing · Dongguan · Kunshan
