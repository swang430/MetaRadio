...
export interface ApiDatasheetDatasheet extends Struct.CollectionTypeSchema {
  collectionName: 'datasheets';
  info: {
    displayName: 'Datasheet';
    pluralName: 'datasheets';
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['White Paper', 'Case Study', 'Blog Post']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Schema.Attribute.DefaultTo<'White Paper'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSolutionSolution extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    solution_details: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    solution_details_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::datasheet.datasheet': ApiDatasheetDatasheet;
